...
def buildClassifiers(training_labels, training_features, testing_labels, testing_features):
	...
	gbc = GradientBoostingClassifier(n_estimators = 150, min_samples_split = 2)
	...
	rf_score = rf.score(testing_features, testing_labels)

	gbc.fit(training_features, training_labels)
	gbc_score = gbc.score(testing_features, testing_labels)

	knn.fit(training_features, training_labels)
	knn_score = knn.score(testing_features, testing_labels)
	...
	print "gradient boosting classifier score: ", gbc_score
	...
	for D in sample_sizes:
		...
		approx_kernel_svm.fit(training_features, training_labels)# entry point
if __name__ == '__main__':

	# Step 1: Reprocess the data into the desired format.
	#file_path = "C:/data/kth/histogramsEval.txt"
